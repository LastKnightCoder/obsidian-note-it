      ...
      <div className='icons-wrapper'>
        <div className='icons'>
          <div className='edit' onClick={handleEditNote}>
            <svg width="16" height="16" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <path 
          ...
          <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4855" data-darkreader-inline-fill="" width="16" height="16">
